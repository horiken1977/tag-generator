...
出力形式: 具体的で有用なタグのみをカンマ区切りで250-300個出力してください。1行ずつではなく、カンマ区切りで連続して出力してください。数が多い方が好ましいです。
`
  }
...
【出力要求】:
- 250-300個の最適化されたタグ（最低250個、理想300個）
- 重複なし
- 具体的で検索に有用
- カンマ区切りで出力

出力: 最適化された250-300個のタグをカンマ区切りで出力してください。数が多い方が好ましいです。
`
  }
